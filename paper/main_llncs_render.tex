% Locally compilable (llncs) fallback rendering of the LeafLens manuscript, for
% previewing without Springer's proprietary sn-jnl class. The SUBMISSION source is
% paper/main.tex, which has been verified to compile cleanly under sn-jnl itself.
% Content, numbers, tables and figures are identical.
