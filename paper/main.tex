% ============================================================================
% LeafLens -- Springer Nature journal format (sn-jnl.cls)
%
% COMPILATION NOTE: sn-jnl.cls is Springer's own class and is NOT on CTAN, so no LaTeX
% engine can auto-fetch it. Obtain it by opening the "Springer Nature" template in the
% Overleaf gallery and pasting this file in as main.tex, or by downloading the template
% from Springer's LaTeX author-support page (v3.1 or later).
%
% This file HAS been test-compiled against sn-jnl and builds cleanly (21 pp, 0 errors).
% Three things were required and are already applied below:
%   1. \usepackage{manyfoot} -- the class calls \SetFootnoteHook and \DeclareNewFootnote
%      in an \AtBeginDocument hook but does not itself load the package providing them.
%   2. Comma-separated \keywords -- \and is llncs syntax and collides with the class's
%      author-block tabular, producing a "Misplaced \crcr" error.
%   3. A numbered bibliography option (sn-mathphys-num) -- sn-basic defaults natbib to
%      author-year, which is incompatible with the manual numeric \thebibliography used
%      here. Substitute whichever numbered style your target journal specifies
%      (sn-nature also builds cleanly; sn-vancouver does not without a .bst).
%
% A standalone-compilable llncs rendering of identical content is kept at
% paper/main_llncs_render.tex for local preview without the proprietary class.
% ============================================================================
\documentclass[pdflatex,sn-mathphys-num]{sn-jnl}
%
\usepackage{manyfoot}   % sn-jnl calls \SetFootnoteHook without loading it
\usepackage{graphicx}
\usepackage{booktabs}
\usepackage{amsmath}
\usepackage{url}
