...
%
% COMPILATION NOTE: sn-jnl.cls is Springer's own class and is NOT on CTAN, so it
% cannot be auto-fetched by any LaTeX engine. Before submitting, either open the
% "Springer Nature" template in the Overleaf gallery and paste this file in as
% main.tex, or download the class from Springer's LaTeX author-support page.
% A standalone-compilable llncs rendering of identical content is kept at
% paper/main_llncs_render.tex for local preview.
% ============================================================================
